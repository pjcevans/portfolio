...
const modals = [
  ...
  {
    thumbnail: todoThumb,
    title: "Extended ToDo article",
    firstHeading: "Who",
    secondHeading: "What",
    thirdHeading: "Which",
    firstContent: "I wanted to contribue to the open source learning community which has been so helpful in my own study. An advanced ToDo application that showcases full CRUD functionality on the front-end using Redux seemed like an effective manner in which to help other developers to discover Redux.",
